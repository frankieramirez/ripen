...
- [ ] Rewriting the compose file preserves comments, YAML anchors/aliases, and header content; the pinned image is written as a quoted "tag@digest" reference (test_updater.py::test_multi_service_update_preserves_compose_comments_and_anchors)
